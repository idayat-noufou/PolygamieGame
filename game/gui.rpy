...
## Cette couleur est utilisé pour le texte d’un bouton sélectionné, mais qui
## n’a pas le focus. Un bouton est sélectionné s’il est sur l’écran actuel ou si
...
##
## Un bouton d’emplacement de fichier est un type spécial de bouton. Il
## contient une vignette et un texte décrivant le contenu de la sauvegarde
## présente dans l’emplacement. Un emplacement de sauvegarde utilise une image
## dans gui/button, comme les autres types de bouton.
...
## La hauteur des barres, des ascenseurs et des curseurs horizontaux. La
## largeur des barres, des ascenseurs et des curseurs verticaux.
...
## La hauteur de l’écran historique ou « None » pour calculer la hauteur au
## prix d’une légère perte de performance.
...
## La position, profondeur et l’alignement du text nvl_tought (Le texte
## prononcé par le personnage nvl_narrator).
...
## Ceci contrôle où un saut de ligne est autorisé. La valeur par défaut
## convient à la plupart des langues. Une liste des valeurs disponible peut
## être trouvée sur https://www.renpy.org/doc/html/style_properties.html#style-
## property-language
